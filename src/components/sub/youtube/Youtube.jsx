        ...
        <div className="con-area">
          ...
          <div className="info">
            <div className="txt">
              ...
              <p>
                With our exceptional video strategies, we ignite inspiration and
                empower individuals to champion their beliefs fearlessly.
                Through visually captivating storytelling and impactful
                messaging, we spark a call to action that resonates deeply. Our
                expert team blends creativity and strategy to create compelling
                video content that drives engagement and provokes meaningful
                conversations. Whether it's a thought-provoking documentary, an
                emotionally charged campaign, or a powerful brand story, we
                craft narratives that leave a lasting impact. Together, let's
            ...
            <div className="video-example">
              <video
                src={`${path.current}/img/services-video-transcode.mp4`}
                alt="services-content-transcode"
                autoPlay
                muted
                loop
                playsInline
          ...
          <div className="info">
            <div className="txt">
              ...
              <p>
                ...
                boundaries. Our strategic approach ensures that your brand story
                is authentically communicated, captivating hearts and minds
                across cultures. Let us guide you in harnessing the true
                potential of your brand, bridging gaps, and leaving an indelible
                mark on a global scale. Together, we can connect the world to
            ...
            <div className="video-example">
              <video
                src={`${path.current}/img/services-branding-transcode.mp4`}
                alt="services-content-transcode"
                autoPlay
                muted
                loop
